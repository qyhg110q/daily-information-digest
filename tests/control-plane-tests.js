...
import { sessionStatus } from "../src/sessions/manager.js";
...
try {
  ...
  const sessionConfig = { ...base, browser: { sessionDir: path.join(directory, "sessions"), storageStatePath: path.join(directory, "legacy.json") }, video: { workDir: path.join(directory, "video-work") } };
